...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME", "Abhay")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME" , "")
# --------------------------------------------------------
BOT_NAME = getenv("BOT_NAME" , "RUdexAbhay Music")
# ---------------------------------------------------------
...
SUDO_USERS = _int_list(getenv("SUDO_USERS"))
# -----------------------------------------------------------------
# -----------------------------------------------------------------
...
CREATOR_NAME = getenv("CREATOR_NAME", "Abhay")
CREATOR_TITLE = getenv("CREATOR_TITLE", "Software Engineer")
CREATOR_PHOTO_URL = getenv("CREATOR_PHOTO_URL", "")
CREATOR_BIO = getenv("CREATOR_BIO", "Creator of RUdexAbhay Music Bot")

WAKE_WORDS = ["babu", "baby", "dj", "abhay", "bot"]
# ----------------------------------------------------------------
